...
window.caishen = {
  ...
  getModelPackages: () => authRequest('/api/model-packages'),
  saveSelectedModelPackage: selectedModelPackageId => authRequest('/api/model-packages/selection', { method: 'PUT', body: JSON.stringify({ selectedModelPackageId }) }),
  cancelJob,
  cancelActiveJobs,
